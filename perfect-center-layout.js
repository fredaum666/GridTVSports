...
const centeredCSS = `    /* HEIGHT-BASED RESPONSIVE - HORIZONTAL LAYOUT FOR SHORT SCREENS */
...
files.forEach(file => {
  ...
  try {
    ...
    if (startIdx !== -1 && endIdx !== -1) {
      content = content.slice(0, startIdx) + centeredCSS + '\n\n    ' + content.slice(endIdx);
      fs.writeFileSync(filePath, content, 'utf8');
      console.log(`✅ ${file} - Applied perfect center layout`);
    } else {
...
console.log('\n✅ Done! Teams should now be perfectly centered in their halves.');
